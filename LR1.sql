...
--•	определить фамилии сотрудников, зарплаты которых >= 2000 и <=4000;
select ename, sal from emp
where sal >= 2000 and sal<=4000;
--из 20 отдела зп >2000
select ename, sal from emp
...
----создать таблицу из 3х столбцов: число, дата, текст
----добавить в нее данные
----выбрать данные при помощи select
