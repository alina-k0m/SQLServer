...
begin 
	...
	if @@ROWCOUNT = 0 print 'Íè÷åãî íå íàøëîñü'
end;
go
...
--	end try
--	begin catch
--		if @@ERROR = 547 print 'Íåëüçÿ óäàëèòü êëèåíòà, ó íåãî åñòü çàêàçû';
--	end catch
--end;
--go
...
begin
	...
	if (@orders_num = 0)
		delete CUSTOMERS where CUST_NUM = @my_CUST_NUM;
	else print 'Íåëüçÿ óäàëèòü êëèåíòà, ó íåãî åñòü çàêàçû';
end;
go
...
--3.1.	Подсчитать количество заказов сотрудника в определенный период. 
	--Если такого сотрудника нет — вернуть -1. Если сотрудник есть, 
